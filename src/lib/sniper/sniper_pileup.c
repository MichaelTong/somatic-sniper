...
int bam_sspileup_file(bamFile fp1, bamFile fp2, int mask, int thresh, bam_sspileup_f func, void *func_data, FILE *snp_fh)
{
    ...
    //  fprintf(stdout, "chr\tpos\tstar\tsomaticQ\tallele1\tallele2\tlength1\tlength2\t"); 
    //  fprintf(stdout, "tumor_cns\ttumor_cnsQ\ttumor_refQ\ttumor_max_mapQ\ttumor_total_num_reads\t"); 
    //  fprintf(stdout, "tumor_allele1_supp_reads\ttumor_allele2_supp_reads\ttumor_ambiguous_reads\ttumor_anti_reads\t");
    //  fprintf(stdout, "tumor_minlk\ttumor_hom_allele1_lk\ttumor_hom_allele2_lk\ttumor_het\t");
    //  fprintf(stdout, "normal_cns\tnormal_cnsQ\tnormal_refQ\tnormal_max_mapQ\tnormal_total_num_reads\t"); 
    //   fprintf(stdout, "normal_allele1_supp_reads\tnormal_allele2_supp_reads\tnormal_ambiguous_reads\tnormal_anti_reads\t");
